...
with open("/root/desc/play-urts/PLAP/configs/prompts/base_template.yaml") as f:
...
with open("/root/desc/play-urts/PLAP/configs/prompts/reflect_template.yaml") as f:
    reflect_template = yaml.safe_load(f)

REFLECT_TEMPLATE = reflect_template["REFLECT_TEMPLATE"]
reflect_prompt = PromptTemplate(
    input_variables=["examples", "observation", "fight_for"], template=REFLECT_TEMPLATE
)
