...
public class JNIBotPLARClient {
     ...
     * @throws Exception
     */
    public JNIBotPLARClient(RewardFunctionInterface[] a_rfs, String a_micrortsPath, String a_mapPath, AI a_ai1, AI a_ai2, UnitTypeTable a_utt, boolean partial_obs) throws Exception{
        ...
        response = new PLARResponse(null, null, null, null, null);
    }
    ...
    public PLARResponse gameStep(int player) throws Exception {
     ...
     * @return PLARResponse after reset.
     * @throws Exception
     */
    public PLARResponse reset(int player) throws Exception {
        ai1 = ai1.clone();
        ai1.reset();
        ai2 = ai2.clone();
        ai2.reset();
