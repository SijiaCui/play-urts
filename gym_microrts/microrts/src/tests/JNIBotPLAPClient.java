...
public class JNIBotPLAPClient {
     ...
     * @throws Exception
     */
    public JNIBotPLAPClient(RewardFunctionInterface[] a_rfs, String a_micrortsPath, String a_mapPath, AI a_ai1, AI a_ai2, UnitTypeTable a_utt, boolean partial_obs) throws Exception{
        ...
        response = new PLAPResponse(null, null, null, null, null);
    }
    ...
    public PLAPResponse gameStep(int player) throws Exception {
     ...
     * @return PLAPResponse after reset.
     * @throws Exception
     */
    public PLAPResponse reset(int player) throws Exception {
        ai1 = ai1.clone();
        ai1.reset();
        ai2 = ai2.clone();
        ai2.reset();
