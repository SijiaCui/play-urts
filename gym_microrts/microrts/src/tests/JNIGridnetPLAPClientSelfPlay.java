 ...
 */
public class JNIGridnetPLAPClientSelfPlay {
    ...
    PLAPResponse[] response = new PLAPResponse[2];
     ...
     * @throws Exception
     */
    public JNIGridnetPLAPClientSelfPlay(RewardFunctionInterface[] a_rfs, String a_micrortsPath, String a_mapPath, UnitTypeTable a_utt, boolean partial_obs) throws Exception{
        ...
        for (int i = 0; i < numPlayers; i++) {
            ...
            response[i] = new PLAPResponse(null, null, null, null, null);
        }
    }
    ...
    public PLAPResponse getResponse(int player) {
