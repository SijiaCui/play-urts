 ...
 */
public class JNIGridnetPLARClient {
     ...
     * @throws Exception
     */
    public JNIGridnetPLARClient(RewardFunctionInterface[] a_rfs, String a_micrortsPath, String a_mapPath, AI a_ai2, UnitTypeTable a_utt, boolean partial_obs) throws Exception{
    ...
    public PLARResponse gameStep(int[][] action, int player) throws Exception {
        if (partialObs) {
