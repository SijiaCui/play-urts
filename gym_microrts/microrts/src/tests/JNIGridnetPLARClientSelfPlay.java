 ...
 */
public class JNIGridnetPLARClientSelfPlay {
    ...
    PLARResponse[] response = new PLARResponse[2];
     ...
     * @throws Exception
     */
    public JNIGridnetPLARClientSelfPlay(RewardFunctionInterface[] a_rfs, String a_micrortsPath, String a_mapPath, UnitTypeTable a_utt, boolean partial_obs) throws Exception{
        ...
        for (int i = 0; i < numPlayers; i++) {
            ...
            response[i] = new PLARResponse(null, null, null, null, null);
        }
    }
    ...
    public PLARResponse getResponse(int player) {
